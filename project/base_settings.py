...
if os.getenv('SDBMYUW_ENV') == 'PROD' or os.getenv('SDBMYUW_ENV') == 'EVAL':
    ...
    RESTCLIENTS_SDBMYUW_TIMEOUT=5
    RESTCLIENTS_SDBMYUW_POOL_SIZE=10

if os.getenv('SDBMYUW_ENV') == 'PROD':
    RESTCLIENTS_SDBMYUW_HOST = 'https://sdb.admin.uw.edu'

if os.getenv('SDBMYUW_ENV') == 'EVAL':
...
if os.getenv('IASYSTEM_UW_ENV') == 'PROD':
...
if os.getenv('IASYSTEM_UWB_ENV') == 'PROD':
...
if os.getenv('IASYSTEM_UWT_ENV') == 'PROD':
...
if os.getenv('IASYSTEM_UWEO_AP_ENV') == 'PROD':
...
if os.getenv('IASYSTEM_UWEO_IELP_ENV') == 'PROD' or os.getenv('IASYSTEM_UWEO_IELP_ENV') == 'EVAL':
    ...
    RESTCLIENTS_IASYSTEM_UWEO_IELP_POOL_SIZE=10

if os.getenv('IASYSTEM_UWEO_IELP_ENV') == 'PROD':
...
if os.getenv('CODA_ENV') == 'PROD' or os.getenv('CODA_ENV') == 'EVAL':
    ...
    RESTCLIENTS_CODA_CERT_FILE = APPLICATION_CERT_PATH
    RESTCLIENTS_CODA_KEY_FILE = APPLICATION_KEY_PATH
    RESTCLIENTS_CODA_POOL_SIZE=10

if os.getenv('CODA_ENV') == 'PROD':
    RESTCLIENTS_CODA_HOST = 'https://coda.uw.edu'

if os.getenv('CODA_ENV') == 'EVAL':
    RESTCLIENTS_CODA_HOST = 'https://coda-test.s.uw.edu'
